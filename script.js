  ...
  $(document).ready(function () {
    ...
    chatbotSend.on('click', () => {
        ...
        if (userMessage) {
            ...
            chatbotMessages.append(`<div class="user-message">${userMessage}</div>`);
            chatbotInput.val('');

            // Simulate a chatbot response
            setTimeout(() => {
                chatbotMessages.append(`<div class="bot-message">Hello! How can I assist you today?</div>`);
